function marketAuth()
{
	...
	{
		storage.get(["tradelink", "steamids"], res =>{
			if(/http:\/\/steamcommunity.com\/profiles\/([0-9]+)\/tradeoffers\/privacy/.exec(jQuery('.formpart.col1:first a').attr('href'))[1] != res.steamids)
			{
